...
// SavvyLayout
#define COCOAPODS_POD_AVAILABLE_SavvyLayout
#define COCOAPODS_VERSION_MAJOR_SavvyLayout 0
#define COCOAPODS_VERSION_MINOR_SavvyLayout 1
#define COCOAPODS_VERSION_PATCH_SavvyLayout 0
